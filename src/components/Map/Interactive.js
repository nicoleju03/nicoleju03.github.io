    ...
    },
    {
        ...
        popupMessage: (
            <div>
                ...
                <br></br>
                <p className='byLineText'>{`Juliana Abraham/Daily Bruin`}</p>
            </div>
        )
    },
    {
    ...
    },
    {
        ...
        popupMessage: (
            <div>
                ...
                <p>Following a back-and-forth first two sets, the UCLA Bruins were able to secure their 20th men's volleyball national championship against Hawaii.</p>
                {/* Insert image from pop-up images folder */}
                <br></br>
